...
return [
    ...
    'recently_created_books' => 'Tutoriels créés récemment',
    ...
    'shelf' => 'catégorie',
    'shelves' => 'Catégories',
    'shelves_long' => 'Catégories',
    'shelves_empty' => 'Aucune catégorie n\'a été créée',
    'shelves_create' => 'Créer une nouvelle catégorie',
    'shelves_popular' => 'Catégories populaires',
    'shelves_new' => 'Nouvelles Catégories',
    'shelves_popular_empty' => 'Les Catégories les plus populaires apparaîtront ici.',
    'shelves_new_empty' => 'Les Catégories les plus récentes apparaitront ici.',
    'shelves_save' => 'Enregistrer la catégorie',
    'shelves_books' => 'Tutoriels pour cette catégorie',
    'shelves_add_books' => 'Ajouter des Tutoriels sur cette catégorie',
    'shelves_drag_books' => 'Déposez des Tutoriels ici pour les ajouter a cette catégorie',
    'shelves_empty_contents' => 'Aucun Tutoriel n\'a été assigné à cette catégorie',
    'shelves_edit_and_assign' => 'Modifier cette catégorie pour y ajouter des Tutoriels',
    'shelves_edit_named' => 'Modifier la catégorie :name',
    'shelves_edit' => 'Modifier la catégorie',
    'shelves_delete' => 'Supprimer la catégorie',
    'shelves_delete_named' => 'Supprimer la catégorie :name',
    'shelves_delete_explain' => "Ceci va supprimer la catégorie nommée \':bookName\'. Les Tutoriels contenus dans cette catégorie ne seront pas supprimés.",
    'shelves_delete_confirmation' => 'Êtes-vous sûr(e) de vouloir supprimer cette catégorie ?',
    'shelves_permissions' => 'Permissions de la catégorie',
    'shelves_permissions_updated' => 'Permissions de la catégorie mises à jour',
    'shelves_permissions_active' => 'Permissions de la catégorie activées',
    'shelves_copy_permissions_to_books' => 'Copier les permissions vers les Tutoriels',
    'shelves_copy_permissions' => 'Copier les permissions',
    'shelves_copy_permissions_explain' => 'Ceci va appliquer les permissions actuelles de cette catégorie à tous les Tutoriels qu\'elle contient. Avant de  continuer, assurez-vous que toutes les permissions de cette catégorie ont été sauvegardées.',
    'shelves_copy_permission_success' => 'Permissions de la catégorie transférées à :count Tutoriels',

    // Books
    'book' => 'Tutoriel',
    'books' => 'Tutoriels',
    'x_books' => ':count Tutoriel|:count Tutoriels',
    'books_empty' => 'Aucun Tutoriel n\'a été créé',
    'books_popular' => 'Tutoriels populaires',
    'books_recent' => 'Tutoriels récents',
    'books_new' => 'Nouveaux Tutoriels',
    'books_new_action' => 'Nouveau Tutoriel',
    'books_popular_empty' => 'Les Tutoriels les plus populaires apparaîtront ici.',
    'books_new_empty' => 'Les Tutoriels les plus récents apparaitront ici.',
    'books_create' => 'Créer un nouveau Tutoriel',
    'books_delete' => 'Supprimer un Tutoriel',
    'books_delete_named' => 'Supprimer le Tutoriel :bookName',
    'books_delete_explain' => 'Ceci va supprimer le Tutoriel nommé \':bookName\', tous les chapitres et pages seront supprimés.',
    'books_delete_confirmation' => 'Êtes-vous sûr(e) de vouloir supprimer ce Tutoriel ?',
    'books_edit' => 'Modifier le Tutoriel',
    'books_edit_named' => 'Modifier le Tutoriel :bookName',
    'books_form_book_name' => 'Nom du Tutoriel',
    'books_save' => 'Enregistrer le Tutoriel',
    'books_permissions' => 'Permissions du Tutoriel',
    'books_permissions_updated' => 'Permissions du Tutoriel mises à jour',
    'books_empty_contents' => 'Aucune page ou chapitre n\'a été ajouté à ce Tutoriel.',
    'books_empty_create_page' => 'Créer une nouvelle page',
    'books_empty_sort_current_book' => 'Trier les pages du Tutoriel',
    'books_empty_add_chapter' => 'Ajouter un chapitre',
    'books_permissions_active' => 'Permissions personnalisées activées',
    'books_search_this' => 'Chercher dans le Tutoriel',
    'books_navigation' => 'Navigation dans le Tutoriel',
    'books_sort' => 'Trier les contenus du Tutoriel',
    'books_sort_named' => 'Trier le Tutoriel :bookName',
    ...
    'books_sort_show_other' => 'Afficher d\'autres Tutoriels',
    ...
    'book_tags' => 'Mots-clés du Tutoriel',
    ...
    'profile_not_created_books' => ':userName n\'a pas créé de Tutoriel',
